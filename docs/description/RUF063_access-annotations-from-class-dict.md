...
Avoiding Undocumented Internals: They provide a stable, public API,
    unlike direct __dict__ access which relies on implementation details.
Forward-Compatibility: They are designed to handle changes in
    ...
    above).
See Python Annotations Best Practices
for alternatives.
## Example
```
...
On Python < 3.10 with typing-extensions
